...
public enum ErrorCode {
    ...
    // User
    EMAIL_NOT_EXISTS(HttpStatus.NOT_FOUND, "존재하지 않는 이메일입니다"),
    ...
    // Concert
    CONCERT_NOT_EXISTS(HttpStatus.NOT_FOUND, "존재하지 않는 게시글입니다"),
    ...
    // Seat
    SEAT_NOT_EXISTS(HttpStatus.NOT_FOUND,"해당 좌석이 존재하지 않습니다."),
    SEAT_NOT_AVAILABLE(HttpStatus.BAD_REQUEST,"해당 좌석은 예약이 불가능합니다"),

    // Ticket
    TICKET_NOT_EXISTS(HttpStatus.NOT_FOUND, "해당 예매내역을 찾을 수 없습니다");
